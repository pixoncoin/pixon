...
This mechanism has been integrated into Bitcore-Node-Pixon which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/pixonpay/insight-api-pixon#web-socket-api](https://github.com/pixonpay/insight-api-pixon#web-socket-api) 
* API: [https://github.com/pixonpay/insight-api-pixon#instantsend-transactions](https://github.com/pixonpay/insight-api-pixon#instantsend-transactions) 
...
By default, the Pixon Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Pixon Core daemon:

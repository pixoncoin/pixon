...
Pixon Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Pixon Core, where everyone uses
...
pay attention to for reviewers of Pixon Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Pixon Core uses tinyformat, which is type safe. Leave them out to avoid confusion

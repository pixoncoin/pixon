...
Only requiring some minor changes is pixon.cpp.
...
Changes to pixon.cpp
----------------------
pixon.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for

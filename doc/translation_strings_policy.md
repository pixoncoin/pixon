...
This document provides guidelines for internationalization of the Pixon Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to Pixon network</numerusform>
            <numerusform>%n active connections to Pixon network</numerusform>
        </translation>
    </message>

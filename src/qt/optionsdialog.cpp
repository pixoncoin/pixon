    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("PXN-light"), QVariant("light"));
    ui->theme->addItem(QString("PXN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("PXN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("PXN-traditional"), QVariant("trad"));

    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Pixon Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Pixon address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pixon: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Pixon Core"), this);
    aboutAction->setStatusTip(tr("Show information about Pixon Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Pixon Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Pixon addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Pixon addresses"));
    ...
    openAction->setStatusTip(tr("Open a pixon: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Pixon Core help message to get a list with possible Pixon Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Pixon Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Pixon network", "", count));
}
...
{
    QString strTitle = tr("Pixon Core"); // default title

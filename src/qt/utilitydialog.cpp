    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Pixon Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Pixon Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  pixon-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Pixon in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 PXN, 0.1 PXN, 1 PXN and 10 PXN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://pixonpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://pixonpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Pixon Core is shutting down...") + "<br /><br />" +

 ...
 *
 *   // network
 *   CPixonNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.pixon.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CPixonNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: PixonNetwork
// //   -- signature requirements : Key1(User)
// class CPixonNetworkVariable : public CGovernanceObject
// {
// private:

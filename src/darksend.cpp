...
{
    if(fLiteMode) return; // ignore all Pixon related functionality
...
/*
    ...
    allow endless transaction that would bloat Pixon and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("pixon-privatesend");
